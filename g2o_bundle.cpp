...
void SetMinimizerOptions(std::unique_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params, g2o::SparseOptimizer* optimizer)
{
    ...
    g2o::OptimizationAlgorithmWithHessian* solver = nullptr;
...
void SetLinearSolver(std::unique_ptr<BalBlockSolver>& solver_ptr, const BundleParams& params)
{
    ...
    std::unique_ptr<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>> pLinearSolver(linearSolver);

    solver_ptr = g2o::make_unique<BalBlockSolver>(std::move(pLinearSolver));
...
{   
    ...
    std::unique_ptr<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>> pLinearSolver(linearSolver);
    solver_ptr.reset(new BalBlockSolver(std::move(pLinearSolver)));
